...
2. QUEST を解く
   ...
   17. [[JavaScript][Level2] クラスを自作し使うことができる](/quest/technologies/javascript/CLASS.md)
   18. [[JavaScript][Level2] 例外処理を使うことができる](/quest/technologies/javascript/EXCEPTION.md)
